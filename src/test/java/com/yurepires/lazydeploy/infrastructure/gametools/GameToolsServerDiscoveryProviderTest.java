...
import com.yurepires.lazydeploy.domain.server.ServerSearchQuery;
...
class GameToolsServerDiscoveryProviderTest {
    ...
    void shouldReturnAllResultsAndMapBattlelogIdAsExternalGuid() {
        String response = """
                {"servers":[
                  {"prefix":"First","battlelogId":"guid-1","serverId":"guid-1","currentMap":"Map one","playerAmount":10,"maxPlayers":64,"inQue":1},
                  {"prefix":"Second","battlelogId":"guid-2","serverId":"guid-2","currentMap":"Map two","playerAmount":20,"maxPlayers":64,"inQue":2}
                ]}
                """;
